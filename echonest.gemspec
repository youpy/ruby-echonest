...
Gem::Specification.new do |s|
  ...
  s.files = ["README", "ChangeLog", "Rakefile", "spec/api_spec.rb", "spec/echonest_spec.rb", "spec/fixtures", "spec/fixtures/get_bars.xml", "spec/fixtures/get_beats.xml", "spec/fixtures/get_duration.xml", "spec/fixtures/get_end_of_fade_in.xml", "spec/fixtures/get_key.xml", "spec/fixtures/get_loudness.xml", "spec/fixtures/get_metadata.xml", "spec/fixtures/get_mode.xml", "spec/fixtures/get_sections.xml", "spec/fixtures/get_segments.xml", "spec/fixtures/get_start_of_fade_out.xml", "spec/fixtures/get_tatums.xml", "spec/fixtures/get_tempo.xml", "spec/fixtures/get_time_signature.xml", "spec/fixtures/sample.mp3", "spec/response_spec.rb", "spec/spec.opts", "spec/spec_helper.rb", "lib/echonest", "lib/echonest/#api.rb#", "lib/echonest/api.rb", "lib/echonest/connection.rb", "lib/echonest/element", "lib/echonest/element/bar.rb", "lib/echonest/element/beat.rb", "lib/echonest/element/loudness.rb", "lib/echonest/element/section.rb", "lib/echonest/element/segment.rb", "lib/echonest/element/tatum.rb", "lib/echonest/element/value_with_confidence.rb", "lib/echonest/response.rb", "lib/echonest/version.rb", "lib/echonest.rb"]
  s.has_rdoc = true
  s.homepage = %q{http://rechonest.rubyforge.org}
  s.rdoc_options = ["--title", "echonest documentation", "--charset", "utf-8", "--opname", "index.html", "--line-numbers", "--main", "README", "--inline-source", "--exclude", "^(examples|extras)/"]
  s.require_paths = ["lib"]
  s.rubyforge_project = %q{rechonest}
